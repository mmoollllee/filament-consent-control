...
>
    <label class="relative inline-flex cursor-pointer items-center gap-2">
        ...
        >
        <div class="h-5 w-9 shrink-0 rounded-full bg-gray-300 transition-colors after:absolute after:left-0.5 after:top-0.5 after:h-4 after:w-4 after:rounded-full after:bg-white after:transition-transform peer-checked:bg-primary-600 peer-checked:after:translate-x-4 peer-disabled:cursor-not-allowed peer-disabled:opacity-50"></div>
        <span
            class="font-medium"
    ...
    @if(!empty($category['children']))
        <ul x-show="!collapsed" class="mt-1 list-none space-y-1">
